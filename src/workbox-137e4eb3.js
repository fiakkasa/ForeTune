define(["exports"], function (t) {
  ...
  (t.CacheFirst = class extends q {
    ...
    (t.NetworkOnly = class extends q {
      constructor(t = {}) {
        super(t), (this.K = t.networkTimeoutSeconds || 0);
      }
      async L(t, e) {
        let n, r;
        try {
          const s = [e.fetch(t)];
          if (this.K) {
            const t = m(1e3 * this.K);
            s.push(t);
          }
          if (((r = await Promise.race(s)), !r))
            throw new Error(
              `Timed out the network response after ${this.K} seconds.`
            );
        } catch (t) {
          t instanceof Error && (n = t);
        }
...
//# sourceMappingURL=workbox-137e4eb3.js.map
